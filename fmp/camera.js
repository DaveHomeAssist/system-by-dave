...
function referenceCards(position) {
  ...
  const showConsole = `https://avbydave.com/av-suite.html?entry=show&sbdVenue=Freedom%20Mortgage%20Pavilion&sbdPhase=loadin`;
  ...
  const items = [
    ...(PUBLIC_RELEASE ? [
      ['SHOW', 'Show Console', 'Show workspace with FMP venue and load-in phase filled', showConsole, true],
