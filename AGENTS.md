...
- Every user-facing page (`index`, `agents`, `skills`, `widgets`,
  ...
  `rf-coordination`, `gear-prep`, `show-advance`, `signal-flow`,
  `stage-plot`, `plotforge`, `show-handoff`, `camera-shot-list`,
  `comms-check`, `av-calculator`, `resume`, `wedding-ops`, `privacy-policy`,
  `404`, `500`) must have:
