...
| --- | --- | --- | --- | --- |
| `housevideo` | housevideo.app | `DaveHomeAssist/housevideo` | `/fmp/` and its routes, `/fmpwalk/`, the `/fmp-index/` and `/fmp-walk/` redirects, `/switcher/` and its routes, `/shader/`, `/ursa-broadcast-g2/`, `/backfocus/` | 2026-09-18 |
