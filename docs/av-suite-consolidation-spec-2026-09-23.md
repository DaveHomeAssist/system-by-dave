...
| The registry lists 44 tools and their registered local-storage keys (59 at `v20260923-shader-practice-relocation`; this figure moves whenever a tool's `storageKeys` change). | `js/sbd-registry.js` | Use the registry to drive navigation and cutover, but audit storage outside it. |
