...
| The registry lists 44 tools and 60 registered local-storage keys. | `js/sbd-registry.js` | Use the registry to drive navigation and cutover, but audit storage outside it. |
