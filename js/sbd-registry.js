...
(function(root){
  ...
  var TOOLS=[
    ...
    {id:'throwline',name:'Throwline',href:'ProjectorThrow/',dept:'Video',phases:['advance','prep','loadin','show'],tag:'Projection',desc:'Offline projector throw, fit, field commissioning, spatial room planning, calculated multi-projector layouts, dimensioned views, camera scope practice, and show handoff.',storageKeys:[{key:'throwline:lenses:v2',label:'Throwline custom lenses'},{key:'throwline:jobs:v2',label:'Throwline saved jobs'},{key:'throwline:shift-profiles:v1',label:'Throwline shift profiles'},{key:'throwline:inventory:v1',label:'Throwline crew inventory'},{key:'throwline:show:v1',label:'Throwline current show'},{key:'throwline:stage-scene:v1',label:'Throwline Stage scenes'},{key:'throwline:stage-onboarding:v1',label:'Throwline Stage onboarding'},{key:'throwline:stage-units:v1',label:'Throwline Stage measurement units'},{key:'throwline.practice.theme.v1',label:'Throwline camera practice theme'},{key:'throwline:theme:v1',label:'Throwline theme'}],toolboxFeatured:true},
  ...
  var BASE_ASSETS=[
    ...
    './ProjectorThrow/practice.html',
    './ProjectorThrow/throwline-practice-state.js',
  ...
  root.SBD_REGISTRY={
    ...
    version:'v20260923-throwline-practice-suite',
    phases:PHASES,
    tools:TOOLS,
