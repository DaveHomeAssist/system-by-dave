...
export const EXERCISE_BRIEFS: Record<ExerciseId, string> = {
  wide: "Frame the whole performance area: both downstage corners and a standing performer's head height at the upstage marks, inside the safe area, and hold it steady.",
