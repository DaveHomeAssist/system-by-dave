import{e as d}from"./index-DZIoNl3p.js";function n(o){return String(o||"").trim().toLowerCase().replace(/[^a-z0-9]+/g,"-").replace(/^-+|-+$/g,"")||"note"}function i(o,e){const t=d(o||"Untitled");return`<!doctype html>
<html lang="en">
<head>
<meta charset="utf-8">
